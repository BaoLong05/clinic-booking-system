  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Object.keys(formData).forEach((key) => {
        ...
        } else if (key === "price" || key === "stock" || key === "weight") {
          // ✅ convert number
          if (formData[key] !== "") {
      ...
      console.log("ERROR:", error.response?.data); // 👈 debug chuẩn
      toast.error(
        editingProduct ? "Cập nhật thất bại" : "Thêm sản phẩm thất bại",
      );
    }
  };
                  ...
                  <tbody>
                    {products.map((product) => (
                      <tr key={product.id}>
                        ...
                        <td>
                          <span
                            className={`stock-badge ${product.stock > 50 ? "normal" : product.stock > 10 ? "low" : product.stock > 0 ? "critical" : "out"}`}
                          >
                            {product.stock}
                          </span>
                        </td>
              ...
              {pagination.last_page > 1 && (
                <div className="products-pagination">
                  <div className="pagination-info">
                    Hiển thị {(pagination.current_page - 1) * 20 + 1} -{" "}
